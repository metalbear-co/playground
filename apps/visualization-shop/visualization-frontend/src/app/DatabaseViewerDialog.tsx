...
interface DatabaseViewerDialogProps {
  dbId: string;
  onClose: () => void;
}
...
export default function DatabaseViewerDialog({
  ...
  return (
    ...
    >
      <div
        className="relative flex h-[80vh] w-[90vw] max-w-6xl overflow-hidden rounded-xl bg-gray-50 shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute right-3 top-3 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white text-gray-500 shadow-sm border border-gray-200 hover:bg-gray-100 hover:text-gray-700 transition-colors"
        >
          &times;
        </button>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white pr-14">
            <div>
