...
export default function ProductDialog({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white shadow-2xl animate-slide-up">
        <button
          type="button"
          onClick={onClose}
          className="absolute right-4 top-4 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white/80 text-slate-600 shadow backdrop-blur transition-colors hover:bg-white hover:text-slate-900"
          aria-label="Close"
        >
          <svg
