...
export default function Header({ showSubtitle = false }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
      <div className="flex min-h-[6.5rem] w-full items-center justify-center bg-[#ff326e] px-6 py-6 text-center text-lg font-extrabold text-[#0A0A46] sm:py-8 sm:text-xl">
