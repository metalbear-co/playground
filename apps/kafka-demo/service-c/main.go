// Service C: consumes kafka-demo.c (terminal service; persists the counter).
//
...
func loadConfig() Config {
	...
	viper.SetDefault("KAFKA_TOPIC", "kafka-demo.c")
	viper.SetDefault("NEXT_TOPIC", "")
	viper.SetDefault("TRACE_TOPIC", "kafka-demo.trace")
	viper.SetDefault("KAFKA_CONSUMER_GROUP", "service-c")
	viper.SetDefault("STAGE", "c")
	viper.SetDefault("SERVICE_NAME", "service-c")
